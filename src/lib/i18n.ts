...
const HI: Record<string, string> = {
  ...
  "Missed call from {name}": "{name} की मिस्ड कॉल",
  "Tap to reply on WhatsApp or call back": "WhatsApp पर जवाब देने या वापस कॉल करने के लिए टैप करें",
...
const TE: Record<string, string> = {
  ...
  "Missed call from {name}": "{name} నుండి మిస్డ్ కాల్",
  "Tap to reply on WhatsApp or call back": "WhatsAppలో జవాబు ఇవ్వడానికి లేదా తిరిగి కాల్ చేయడానికి నొక్కండి",
